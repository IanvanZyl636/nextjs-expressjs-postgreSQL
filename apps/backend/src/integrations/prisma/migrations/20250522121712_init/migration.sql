...
-- AddForeignKey
ALTER TABLE "Season" ADD CONSTRAINT "Season_championConstructorId_fkey" FOREIGN KEY ("championConstructorId") REFERENCES "Constructor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Race" ADD CONSTRAINT "Race_winnerConstructorId_fkey" FOREIGN KEY ("winnerConstructorId") REFERENCES "Constructor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
